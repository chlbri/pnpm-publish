...
import { relative as c, resolve as l } from 'node:path';
import * as u from 'node:os';
import d, { EOL as f } from 'node:os';
...
function x(e, t, n) {
  let r = new S(e, t, n);
  process.stdout.write(r.toString() + u.EOL);
}
var S = class {
  constructor(e, t, n) {
    ((e ||= `missing.command`),
...
function T(e, n) {
  ...
  if (!t.existsSync(r)) throw Error(`Missing file at path: ${r}`);
  t.appendFileSync(r, `${b(n)}${u.EOL}`, { encoding: `utf8` });
}
function E(e, t) {
  let n = `ghadelimiter_${p.randomUUID()}`,
    r = b(t);
  if (e.includes(n))
    throw Error(
...
const { access: xt, appendFile: St, writeFile: Ct } = i,
      ...
      return (
        ...
        new Promise((e, t) =>
          qt(this, void 0, void 0, function* () {
            ...
            !n.silent &&
              n.outStream &&
              n.outStream.write(this._getCommandString(n) + u.EOL);
            ...
            if (
              ...
              r.on(`done`, (n, r) => {
                (o.length > 0 && this.emit(`stdline`, o),
                  s.length > 0 && this.emit(`errline`, s),
                  a.removeAllListeners(),
                  n ? t(n) : e(r));
              }),
              this.options.input)
            ) {
              if (!a.stdin) throw Error(`child process missing stdin`);
...
function nn(e, t) {
  ...
  (process.stdout.write(u.EOL), x(`set-output`, { name: e }, b(t)));
}
const rn = () => ({
  ...
  an = (e = `./pnpm-publish-summary.json`) => a(e).toLocaleString(),
  on = e => `./${c(`.`, l(e, `package.json`))}`,
  sn = ({
    access: e,
    tag: t,
    publishBranch: n,
    ...
    '~run'(e, t) {
      ...
      if (n && typeof n == `object`) {
        ...
        for (let r in this.entries) {
          ...
          } else if (i.fallback !== void 0) e.value[r] = yn(i);
          else if (
            i.type !== `exact_optional` &&
            i.type !== `optional` &&
            i.type !== `nullish` &&
...
const On = (...e) => {
    ...
    if (
      ...
      t.forEach(kn(`PNPM publish warns with codes`)),
      t.length > 0)
    )
      return t;
  },
  ...
  Mn = (e = {}) => {
    ...
    let t = An(e.registry ?? `npm`),
      ...
      f = d.some(e => e.startsWith(`registry=`)),
      p = d.find(e => e.startsWith(`//${s}/:_authToken=`));
    return (
      f || d.push(c),
      p || d.push(l),
      o(
...
`)}\n`,
      ...
      { created: !u, filePath: i, registry: t }
    );
  },
  Nn = Tn(
    ...
    gn({}, `Not a json`),
    xn(),
    _n(e => e.publishedPackages),
    Sn(Cn({ name: wn(), version: wn() })),
  ),
  Pn = async e => On(...(await Dn(e)).warnings),
  Fn = async () => {
    let { errors: e, result: t } = await Dn(an(), Nn);
    return (e.schema.forEach(kn(`SUMMARY JSON SCHEMA validation`)), t);
  },
  In = async () => {
    let { command: e, inputs: t } = cn();
    return (
      Mn({ authToken: t.AUTH, registry: t.registry }),
      (await Pn(e))
        ? { inputs: t, result: void 0 }
        : { result: await Fn(), inputs: t }
    );
  },
  Ln = (e, t) => {
    t && nn(e, t);
  ...
  zn = async (e, t) => {
    let { errors: n, result: r } = await Dn(
      `pnpm view ${t} versions`,
      Sn(wn()),
    );
    return (
      n.schema.forEach(kn(`JSON SCHEMA validation`)),
  ...
  Hn = async e => Vn(`version`, e),
  Un = async e => Vn(`name`, e);
(async () => {
  let { inputs: e, result: t } = await In();
  if (t === void 0 || t.length === 0) {
    let t = await Bn(await Hn(e.filter), e.filter);
    return Rn({
      tag: e.tag,
      access: e.access,
