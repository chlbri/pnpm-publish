...
`,
  ...
  A = _((e, t) => {
    ...
    let B = Symbol.for(`undici.error.UND_ERR_REQ_RETRY`);
    ...
    let re = Symbol.for(`undici.error.UND_ERR_RESPONSE`);
    ...
    let V = Symbol.for(`undici.error.UND_ERR_PRX_TLS`);
    var H = class extends r {
      constructor(e, t, n) {
        (super(t, { cause: e, ...(n ?? {}) }),
    ...
    let U = Symbol.for(`undici.error.UND_ERR_WS_MESSAGE_SIZE_EXCEEDED`);
    t.exports = {
      AbortError: y,
      HTTPParserError: R,
      UndiciError: r,
...
`) ||
  ...
  W = _((e, t) => {
    let { isBlobLike: n, iteratorMixin: r } = U(),
      { kState: i } = ae(),
      { kEnumerableProperty: a } = N(),
      { FileLike: o, isFileLike: s } = oe(),
      { webidl: c } = H(),
  ...
  G = _((e, t) => {
    let { isUSVString: n, bufferToLowerCasedHeaderName: r } = N(),
      { utf8DecodeBytes: i } = U(),
      { HTTP_TOKEN_CODEPOINTS: a, isomorphicDecode: o } = V(),
      { isFileLike: s } = oe(),
      { makeEntry: c } = W(),
      l = v(`node:assert`),
...
Content-Type: ${c.type || `application/octet-stream`}\r\n\r\n`,
  ...
  K = _((e, t) => {
    let n = v(`node:assert`),
      ...
      de;
    async function fe() {
      let e = process.env.JEST_WORKER_ID ? B() : void 0,
        t;
      try {
    ...
    function ye(e) {
      ...
      if (t && !t.destroyed) {
        if (
          ...
          let n = e[E][e[F]],
            r = n.headersTimeout == null ? e[H] : n.headersTimeout;
          t[b].setTimeout(r, 3);
        }
      }
    }
    ...
    function xe(e, t) {
      ...
      if (
        ...
        if (e[ae]) return (r.errorRequest(e, t, new o()), !1);
  ...
  q = _((e, t) => {
    ...
    async function B(e, t) {
      ...
      ((r[D] = 0),
        (r[d] = e),
        (r[y] = t),
        i.addListener(r, `error`, re),
        i.addListener(r, `frameError`, ie),
        i.addListener(r, `end`, V),
    ...
    function ae(e, t) {
      ...
      if (
        ((M ??= t.contentLength),
        (M === 0 || !j) && (M = null),
        U(s) && M > 0 && t.contentLength != null && t.contentLength !== M)
      ) {
      ...
      return (
        p
          ? ((S[R] = `100-continue`),
            ...
            T.once(`continue`, B))
          : ((T = r.request(S, { endStream: N, signal: _ })), B()),
        ++r[D],
        T.once(`response`, n => {
          let { [z]: r, ...a } = n;
      ...
      function B() {
        !x || M === 0
          ? oe(A, T, null, e, t, e[y], M, j)
          : i.isBuffer(x)
            ? oe(A, T, x, e, t, e[y], M, j)
            : i.isBlobLike(x)
    ...
    var ge = class extends c {
      constructor(
        e,
        {
          ...
          maxResponseSize: L,
          autoSelectFamily: R,
          autoSelectFamilyAttemptTimeout: oe,
        ...
        (typeof P != `function` &&
          (P = f({
            ...
            timeout: u,
            ...(R
              ? { autoSelectFamily: R, autoSelectFamilyAttemptTimeout: oe }
              : void 0),
            ...P,
          })),
...
`.trim(),
  ...
  Be = _((e, t) => {
    let {
      ...
      { redirectStatusSet: E, nullBodyStatus: D } = re(),
      { kState: O, kHeaders: A } = ae(),
      { webidl: j } = H(),
      { FormData: M } = W(),
      { URLSerializer: P } = V(),
      { kConstruct: F } = k(),
    ...
    function z(e) {
      if (e.internalResponse) return oe(z(e.internalResponse), e.type);
    ...
    function oe(e, t) {
      if (t === `basic`)
        return ie(e, { type: `basic`, headersList: e.headersList });
      if (t === `cors`)
        return ie(e, { type: `cors`, headersList: e.headersList });
      if (t === `opaque`)
        return ie(e, {
          type: `opaque`,
  ...
  He = _((e, t) => {
    let {
      ...
      { kHeaders: M, kSignal: P, kState: F, kDispatcher: I } = ae(),
      { webidl: L } = H(),
      { URLSerializer: ee } = V(),
      { kConstruct: R } = k(),
      z = v(`node:assert`),
      {
        getMaxListeners: te,
        setMaxListeners: B,
        getEventListeners: ne,
        defaultMaxListeners: ie,
      } = v(`node:events`),
      oe = Symbol(`abortController`),
      ...
      constructor(t, r = {}) {
        ...
        if (((this[P] = E.signal), v != null)) {
          ...
          if (v.aborted) E.abort(v.reason);
            ...
            try {
              ((typeof te == `function` && te(v) === ie) ||
                ne(v, `abort`).length >= ie) &&
                B(1500, v);
            } catch {}
  ...
  Ue = _((e, t) => {
    let {
      ...
      u = v(`node:zlib`),
      {
        ...
        buildContentRange: ne,
        createInflate: ie,
        extractMimeType: oe,
      } = U(),
      { kState: W, kDispatcher: G } = ae(),
      K = v(`node:assert`),
  ...
  qe = _((e, t) => {
    let {
      ...
      { ProgressEvent: s } = Ge(),
      { getEncoding: c } = Ke(),
      { serializeAMimeType: l, parseMIMEType: u } = V(),
      { types: d } = v(`node:util`),
  ...
  tt = _((e, t) => {
    let { maxNameValuePairSize: n, maxAttributeValueSize: r } = $e(),
      ...
      { collectASequenceOfCodePointsFast: a } = V(),
      o = v(`node:assert`);
    function s(e) {
      if (i(e)) return null;
      let t = ``,
  ...
  gt = _((e, t) => {
    ...
    let { setGlobalOrigin: O, getGlobalOrigin: k } = ie();
    ...
    let { parseMIMEType: z, serializeAMimeType: te } = V();
    ((t.exports.parseMIMEType = z), (t.exports.serializeAMimeType = te));
    let { CloseEvent: B, ErrorEvent: ne, MessageEvent: re } = rt();
    ((t.exports.WebSocket = ft().WebSocket),
      (t.exports.CloseEvent = B),
      (t.exports.ErrorEvent = ne),
      (t.exports.MessageEvent = re),
...
const rn = () => ({
  ...
  an = (e = `./pnpm-publish-summary.json`) =>
    `node -p 'JSON.stringify(require("${e}").publishedPackages, null, 2)'`,
...
`)}\n`,
  ...
  Mn = async e => En(...(await Tn(e)).warnings),
  Nn = async () => {
  ...
  Bn = async e => zn(`version`, e),
  Vn = async e => zn(`name`, e);
(async () => {
  let { inputs: e, result: t } = await Pn();
  if (t === void 0 || t.length === 0) {
    let t = await Rn(await Bn(e.filter), e.filter);
    return In({
      tag: e.tag,
      access: e.access,
