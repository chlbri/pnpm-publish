...
function N(e) {
  if (((e = F(e)), !e)) throw Error(`isRooted() parameter "p" cannot be empty`);
  ...
  _getSpawnArgs(e) {
    if (B && this._isCmdFile()) {
      ...
      for (let n of this.args)
        ((t += ` `),
          (t += e.windowsVerbatimArguments ? n : this._windowsQuoteCmdArg(n)));
      return ((t += `"`), [t]);
    }
    return this.args;
  }
        ...
        new Promise((e, t) =>
          z(this, void 0, void 0, function* () {
            ...
            if (
              ...
              return t(Error(`The cwd: ${this.options.cwd} does not exist!`));
...
function G(e, n, r) {
  return U(this, void 0, void 0, function* () {
    let i = ``,
      ...
      d = yield W(e, n, Object.assign(Object.assign({}, r), { listeners: u }));
    return (
      (i += o.end()),
      (a += s.end()),
      { exitCode: d, stdout: i, stderr: a }
    );
  });
}
function K(e) {
...
function q(e) {
  return K(e).replace(/%/g, `%25`).replace(/\r/g, `%0D`).replace(/\n/g, `%0A`);
}
function ie(e) {
  return K(e)
    .replace(/%/g, `%25`)
...
function ae(e, t) {
  ...
  if (!r)
    throw Error(`Unable to find environment variable for file command ${e}`);
...
`,
    ...
    function L(e, t) {
      e == null ||
        ...
        (typeof e.destroy == `function`
          ? (Object.getPrototypeOf(e).constructor === s && (e.socket = null),
            e.destroy(t))
          : t &&
            queueMicrotask(() => {
              e.emit(`error`, t);
  ...
  ue = g((e, t) => {
    ...
    var S = class {
      ...
      onRequestSent() {
        if (
          (v.bodySent.hasSubscribers && v.bodySent.publish({ request: this }),
    ...
    function C(e, t, i) {
      ...
      if (i === void 0) return;
      let s = y[t];
      if (s === void 0 && ((s = t.toLowerCase()), y[s] === void 0 && !a(s)))
  ...
  fe = g((e, t) => {
    ...
    function c() {
      i
        ? i.refresh()
        : (clearTimeout(i), (i = setTimeout(s, 499)), i.unref && i.unref());
    }
    var l = class {
      [a] = !0;
      _state = -2;
  ...
  xe = g((e, t) => {
    ...
    ((o.converters = {}),
      ...
      (o.converters[`sequence<sequence<ByteString>>`] = o.sequenceConverter(
        o.converters[`sequence<ByteString>`],
      )),
  ...
  Se = g((e, t) => {
    let { Transform: n } = _(`node:stream`),
      r = _(`node:zlib`),
      { redirectStatusSet: i, referrerPolicySet: a, badPortsSet: o } = ve(),
...
`) ||
    ...
    function K(e, t) {
      ...
      for (let t of r) {
        ...
        if (
          (i[i.length - 1] === `=` &&
            (i = i[i.length - 2] === `=` ? i.slice(0, -2) : i.slice(0, -1)),
          ae(i, r))
        )
          return !0;
      }
      ...
      for (;;) {
        ...
        switch ((t.position++, S((e) => e === 32 || e === 9, e, t), r(l))) {
          case `content-disposition`:
            if (
              ((n = i = null),
              !w(e, f, t) || ((t.position += 17), (n = x(e, t)), n === null))
            )
              return `failure`;
            if (w(e, p, t)) {
...
Content-Type: ${c.type || `application/octet-stream`}\r\n\r\n`,
      ...
      if (
        ((typeof l == `string` || n.isBuffer(l)) && (u = Buffer.byteLength(l)),
        c != null)
      ) {
        let t;
  ...
  Oe = g((e, t) => {
    ...
    var de = class {
      ...
      setTimeout(e, t) {
        (e !== this.timeoutValue || (t & 1) ^ (this.timeoutType & 1)
          ? ((this.timeout &&= (a.clearTimeout(this.timeout), null)),
            e &&
              (t & 1
                ? (this.timeout = a.setFastTimeout(pe, e, new WeakRef(this)))
      ...
      execute(e) {
        ...
        try {
          ...
          if (n !== K.ERROR.OK) {
            ...
            else if (n === K.ERROR.PAUSED) ((this.paused = !0), t.unshift(i));
      ...
      onHeadersComplete(e, t, i) {
        ...
        if ((n(!this.upgrade), n(this.statusCode < 200), e === 100))
          return (r.destroy(o, new d(`bad response`, r.getSocketInfo(o))), -1);
        if (t && !l.upgrade)
    ...
    function pe(e) {
      ...
      i === 3
        ...
        : i === 5
          ? o || r.destroy(t, new p())
          : i === 8 &&
            (n(a[S] === 0 && a[F]), r.destroy(t, new f(`socket idle timeout`)));
    }
    ...
    function be(e, t) {
      ...
      if (
        ...
        g === 0 && !_ && (g = null),
        ye(a) && g > 0 && t.contentLength !== null && t.contentLength !== g)
      ) {
...
`,
      ...
      destroy(e) {
        ...
        ((t[T] = !1),
          e &&
            (n(r[S] <= 1, `pipeline should only contain this request`), i(e)));
      }
    };
    t.exports = me;
  }),
  ke = g((e, t) => {
    ...
    async function R(e, t) {
      ...
      ((r[D] = 0),
        ...
        i.addListener(r, `close`, function () {
          let { [d]: e } = this,
            { [y]: t } = e,
            r = this[y][v] || this[v] || new s(`closed`, i.getSocketInfo(t));
    ...
    function W(e, t) {
      ...
      return (
        ...
        T.once(`end`, () => {
          ((T.state?.state == null || T.state.state < 6) && t.onComplete([]),
            r[D] === 0 && r.unref(),
  ...
  Ae = g((e, t) => {
    ...
    function f(e, t, r) {
      ...
      if (r && (e.length === 13 || e.length === 6 || e.length === 19)) {
        ...
        return (
          t === `authorization` || t === `cookie` || t === `proxy-authorization`
        );
      }
      return !1;
    }
    ...
    async function ge(e) {
      ...
      try {
        ...
        if (
          ...
          for (n(e[b] === 0); e[x] > 0 && e[C][e[k]].servername === e[m]; ) {
            let t = e[C][e[k]++];
      ...
      PoolBase: class extends n {
        constructor(e) {
          ...
          ((this[b] = function (e, n) {
            ...
            ((this[_] = i),
              !this[_] && t[_] && ((t[_] = !1), t.emit(`drain`, e, [t, ...n])),
              t[y] &&
                r.isEmpty() &&
  ...
  Le = g((e, t) => {
    let { BalancedPoolMissingUpstreamError: n, InvalidArgumentError: r } = Y(),
      {
        PoolBase: i,
        kClients: a,
        kNeedDrain: o,
    ...
    t.exports = class extends i {
      ...
      addUpstream(e) {
        ...
        if (
          this[a].find(
            (e) => e[d].origin === t && e.closed !== !0 && e.destroyed !== !0,
          )
        )
          return this;
        ...
        constructor(e) {
          ...
          let M = e.factory || D,
            N = (e, t) => {
              ...
              return !this[C] && r === `http:` && this[n].protocol === `http:`
                ? new O(this[n].uri, {
                    headers: this[y],
                    connect: j,
                    factory: M,
  ...
  Ve = g((e, t) => {
    ...
    t.exports = class e {
      ...
      onHeaders(e, t, r, a) {
        ...
        if (this.resume != null) {
          if (
            ((this.resume = null), e !== 206 && (this.start > 0 || e !== 200))
          )
            return (
              this.abort(
                new i(
          ...
          return (
            ...
            n(this.end == null || this.end === l, `content-range mismatch`),
            (this.resume = r),
            !0
          );
        }
  ...
  Ge = g((e, t) => {
    ...
    var l = class extends c {
            ...
            (this.signal.aborted
              ...
              : (this.removeAbortListener = o.addAbortListener(
                  ...
                  () => {
                    ((this.reason = this.signal.reason ?? new a()),
                      this.res
                        ? o.destroy(this.res.on(`error`, o.nop), this.reason)
      ...
      onHeaders(e, t, n, i) {
        ...
        (this.removeAbortListener && _.on(`close`, this.removeAbortListener),
          (this.callback = null),
          (this.res = _),
          a !== null &&
  ...
  Ke = g((e, t) => {
    let { addAbortListener: n } = Q(),
      ...
      a = Symbol(`kSignal`);
    function o(e) {
      (e.abort ? e.abort(e[a]?.reason) : (e.reason = e[a]?.reason ?? new r()),
        c(e));
    }
    function s(e, t) {
  ...
  et = g((e, t) => {
    ...
    function b(e, t) {
      ...
      if (((a = a.filter(({ method: e }) => d(e, t.method))), a.length === 0))
        throw new n(
          `Mock dispatch not matched for method '${t.method}' on path '${i}'`,
        );
      if (
        ((a = a.filter(({ body: e }) => (e === void 0 ? !0 : d(e, t.body)))),
        a.length === 0)
      )
        throw new n(
    ...
    function w(e) {
      ...
      for (let r = 0; r < t.length; ++r) {
        let i = t[r],
          ...
          o = Buffer.from(`${i}`);
        if (Array.isArray(a))
          for (let e = 0; e < a.length; ++e) n.push(o, Buffer.from(`${a[e]}`));
    ...
    function D(e, t) {
      let n = C(e),
        i = b(this[r], n);
      (i.timesInvoked++,
        i.data.callback && (i.data = { ...i.data, ...i.data.callback(e) }));
      let {
            ...
            return new p(
              i(this[a], this[o], (t) => {
                ...
                if (typeof n != `object` || !n)
                  throw new d(`reply options callback must return an object`);
...
`.trim(),
  ...
  dt = g((e, t) => {
    ...
    var o = class extends a {
      ...
      onHeaders(e, t, r, a) {
        ...
        if (o != null && o > this.#e)
          throw new i(`Response size (${o}) larger than maxSize (${this.#e})`);
          ...
          return n(a.hostname) === 0
            ? (i.runLookup(a, t, (n, o) => {
                ...
                ((s = {
                  ...
                  e(
                    s,
                    i.getHandler({ origin: a, dispatch: e, handler: r }, t),
                  ));
              }),
              !0)
            : e(t, r);
  ...
  pt = g((e, t) => {
    let { kConstruct: n } = J(),
      ...
      { iteratorMixin: i, isValidHeaderName: a, isValidHeaderValue: o } = Se(),
      { webidl: s } = xe(),
      c = _(`node:assert`),
      l = _(`node:util`),
      ...
      (s.converters.HeadersInit = function (e, t, n) {
        if (s.util.Type(e) === `Object`) {
          ...
          return typeof r == `function`
            ? s.converters[`sequence<sequence<ByteString>>`](e, t, n, r.bind(e))
  ...
  mt = g((e, t) => {
    ...
    var L = class e {
      ...
      get body() {
        return (
          A.brandCheck(this, e),
          this[O].body ? this[O].body.stream : null
        );
      }
      get bodyUsed() {
        return (
    ...
    function U(e, t, n) {
      ...
      if (`statusText` in t && t.statusText != null && !v(String(t.statusText)))
    ...
    ((A.converters.ReadableStream = A.interfaceConverter(ReadableStream)),
      ...
      (A.converters.URLSearchParams = A.interfaceConverter(URLSearchParams)),
  ...
  gt = g((e, t) => {
    let { extractBody: n, mixinBody: r, cloneBody: i, bodyUnusable: a } = De(),
      {
        Headers: o,
        fill: s,
        HeadersList: c,
    ...
    var K = class e {
      constructor(t, r = {}) {
        ...
        if (
          ...
          if (!x.has(u.method))
            throw TypeError(`'${u.method} is unsupported in no-cors mode.`);
      ...
      get body() {
        return (
          F.brandCheck(this, e),
          this[N].body ? this[N].body.stream : null
        );
      }
      get bodyUsed() {
        return (
  ...
  _t = g((e, t) => {
    ...
    function Oe(e, t = `other`) {
      ...
      ee(n) &&
        r !== null &&
        (e.timingAllowPassed || ((r = S({ startTime: r.startTime })), (i = ``)),
        (r.endTime = D()),
        (e.timingInfo = r),
    ...
    async function ze(e, t = !1, i = !1) {
      ...
      try {
        ...
        if (o) c = a({ status: n, statusText: r, headersList: i, socket: o });
        else {
      ...
      ((c.body = { stream: m, source: null, length: null }),
        ...
        (e.controller.resume = async () => {
          for (;;) {
            ...
            if ((r.byteLength && e.controller.controller.enqueue(r), Z(m))) {
  ...
  yt = g((e, t) => {
    ...
    var i = class e extends Event {
      constructor(e, t = {}) {
        ((e = n.converters.DOMString(e, `ProgressEvent constructor`, `type`)),
  ...
  St = g((e, t) => {
    ...
    var f = class e extends EventTarget {
      ...
      readAsArrayBuffer(t) {
        (u.brandCheck(this, e),
          u.argumentLengthCheck(arguments, 1, `FileReader.readAsArrayBuffer`),
          (t = u.converters.Blob(t, { strict: !1 })),
          r(this, t, `ArrayBuffer`));
      }
      readAsBinaryString(t) {
        (u.brandCheck(this, e),
          u.argumentLengthCheck(arguments, 1, `FileReader.readAsBinaryString`),
          (t = u.converters.Blob(t, { strict: !1 })),
      ...
      set onloadstart(t) {
        (u.brandCheck(this, e),
          ...
          typeof t == `function`
            ? ((this[c].loadstart = t), this.addEventListener(`loadstart`, t))
      ...
      set onprogress(t) {
        (u.brandCheck(this, e),
          ...
          typeof t == `function`
            ? ((this[c].progress = t), this.addEventListener(`progress`, t))
    ...
    var b = class e {
      ...
      #r(e, t, n = null, a) {
        let o = new URL(e.url),
          s = new URL(t.url);
        if (
          (a?.ignoreSearch && ((s.search = ``), (o.search = ``)), !r(o, s, !0))
        )
          return !1;
  ...
  Pt = g((e, t) => {
    let {
      ...
      { collectASequenceOfCodePointsFast: f, removeHTTPWhitespace: p } = be();
    function m(e) {
  ...
  Rt = g((e, t) => {
    let { Writable: n } = _(`node:stream`),
      ...
      { kReadyState: l, kSentClose: u, kResponse: d, kReceivedClose: f } = Nt(),
      { channels: p } = le(),
      {
        isValidStatusCode: m,
        isValidOpcode: h,
    ...
    t.exports = {
      ByteParser: class extends n {
        ...
        run(e) {
          for (; this.#r; )
            if (this.#i === i.INFO) {
              ...
              if (b(this.#a.opcode))
                ((this.#r = this.parseControlFrame(t)), (this.#i = i.INFO));
                ...
                (this.#s
                  ...
                  .decompress(t, this.#a.fin, (t, n) => {
                    ...
                    if (
                      (this.writeFragments(n), this.#c > 0 && this.#t > this.#c)
                    ) {
                ...
                if (
                  (this.writeFragments(t), this.#c > 0 && this.#t > this.#c)
                ) {
                  g(this.ws, new E().message);
                  return;
                }
        ...
        parseCloseBody(e) {
          r(e.length !== 1);
          let t;
          if ((e.length >= 2 && (t = e.readUInt16BE(0)), t !== void 0 && !m(t)))
            return {
              code: 1002,
  ...
  Bt = g((e, t) => {
    let { webidl: n } = xe(),
      ...
      { establishWebSocketConnection: S, closeWebSocketConnection: C } = It(),
      { ByteParser: w } = Rt(),
    ...
    ((M.CONNECTING = M.prototype.CONNECTING = o.CONNECTING),
      ...
      (n.converters[`DOMString or sequence<DOMString>`] = function (e, t, r) {
    ...
    var h = class e extends EventTarget {
      ...
      constructor(e, t = {}) {
        ...
        (a.argumentLengthCheck(arguments, 1, n),
          ...
          (t = a.converters.EventSourceInitDict(t, n, `eventSourceInitDict`)),
          (this.#o = t.dispatcher),
...
const nn = () => ({
  ...
  on = (e) => {
    ...
    if (t.length === 0 || t === `npm`) return `https://registry.npmjs.org/`;
...
`)}\n`,
  ...
  dn = async () => {
    ...
    let { warnings: n } = await un(),
      r = n.join(`
`);
    return { result: r ? JSON.parse(r) : void 0, inputs: t };
  },
  fn = (e, t) => {
    t && tn(e, t);
  },
...
(async () => {
  let { inputs: e, result: t } = await dn();
  if (t === void 0 || t.length === 0) {
    ...
    let n = await hn(t[0].version, t[0].name),
